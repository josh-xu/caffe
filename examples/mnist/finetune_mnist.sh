...
rm -rf examples/mnist/lenet_finetune_iter_10000.caffemodel
...
rm -rf examples/mnist/lenet_iter_25000.caffemodel
rm -rf examples/mnist/lenet_iter_30000.caffemodel

rm -rf examples/mnist/lenet_finetune_iter_10000.solverstate
...
rm -rf examples/mnist/lenet_iter_25000.solverstate
rm -rf examples/mnist/lenet_iter_30000.solverstate

./build/tools/caffe train \
    --solver=examples/mnist/lenet_solver_10000.prototxt \
